...
# Configuración de CORS para permitir solicitudes desde el frontend en GitHub Pages y Render
...
# Configuración de claves de API y variables de entorno
...
# Llamar a create_tables al iniciar el servidor
create_tables()
...
def chatgpt():
    ...
    # Mensaje de sistema para la especialidad
    system_message = {
        "role": "system",
